...
const configured: LabConfiguration = {
  resources: [
    ...
    { id: 'distribution-1', type: 'cloudFrontDistribution', name: 'site-delivery', originBucketId: 'bucket-1', enabled: true, originAccessControl: true },
    { id: 'function-1', type: 'lambdaFunction', name: 'app-function' },
    { id: 'route-1', type: 'apiRoute', name: 'items-route', path: '/api/items', method: 'ANY', lambdaId: 'function-1' },
    { id: 'table-1', type: 'dynamoTable', name: 'app-items', partitionKey: 'id' },
    { id: 'policy-1', type: 'iamPolicy', name: 'function-table-access', lambdaId: 'function-1', tableId: 'table-1', accessLevel: 'read-write' },
    { id: 'logs-1', type: 'cloudWatchLogGroup', name: '/aws/lambda/app-function', lambdaId: 'function-1', retentionDays: 7 },
    { id: 'alarm-1', type: 'cloudWatchAlarm', name: 'function-errors', lambdaId: 'function-1', metric: 'Errors' },
  ],
};
...
test('a distribution cannot make a public or unrelated bucket a valid origin', () => {
  ...
  configuration.resources[0] = { id: 'bucket-1', type: 's3Bucket', name: 'my-web-assets', blockPublicAccess: false };
